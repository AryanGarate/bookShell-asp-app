        ...
        /*     public ActionResult DeleteCart(int id)
             {
                 ...
                 catch (CartException ex)
                 {
                     ...
                     return StatusCode(404, responseML); // 404 Not Found if specific to the entity not being found
                 }
                 catch (Exception ex)
                 {
                     responseML.Success = false;
                     responseML.Message = "An unexpected error occurred.";

                     // Optionally log the exception details
                     return StatusCode(500, responseML); // 500 Internal Server Error for unexpected errors
                 }
             }*/
